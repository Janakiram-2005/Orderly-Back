...
// ✅ Login Form (MODIFIED with real auth logic)
const LoginForm = ({ setIsLoginView }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call the CUSTOMER login endpoint
      const response = await axios.post('/api/auth/customer/login', {
        email,
        password,
      });

      // Get full user data and token from response
  ...
  return (
    <>
      <h3 className="fw-semibold mb-2">Log in to your account</h3>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <Form.Check type="checkbox" label="Remember me" id="remember-me" disabled={isLoading} />
        ...
        <Button type="submit" className="w-100 btn-brand" disabled={isLoading}>
...
// ✅ Register Form (MODIFIED with real API call)
const RegisterForm = ({ setIsLoginView }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call the CUSTOMER register endpoint
      await axios.post('/api/auth/customer/register', {
        name: fullName,
        email,
        password,
        phone,
  ...
  return (
    <>
      ...
      <p className="text-muted mb-4">Join us and start shopping locally.</p>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group className="mb-3" controlId="address">
          <Form.Label className="fw-medium">Delivery Address</Form.Label>
          <Form.Control 
            type="text" 
        ...
        <Button type="submit" className="w-100 mt-2 btn-brand" disabled={isLoading}>
...
const CustomerAuthPage = () => {
  ...
  // Removed navigate from here, as it's now used inside the forms
